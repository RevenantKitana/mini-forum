...
**Definition of Done (DoD)** là thỏa thuận minh bạch giữa người thực hiện và Product Owner về tiêu chí để một User Story được tính là hoàn thành. DoD không phải là danh sách Acceptance Criteria của từng story (đó là "Definition of Ready") — DoD là **bộ tiêu chí kỹ thuật chung áp dụng cho TẤT CẢ stories** của dự án.
